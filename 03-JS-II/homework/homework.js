...
function esEntero(numero) {
  ...
  // Tu código:
 if( numero > 1 || numero == 0 || numero< 0 ){ return true}
 else {return false }
...
function esPrimo(numero) {
  ...
  if (numero==2) {return true;} else if (numero < 2){return false}
...
function esVerdadero(valor){
  ...
  //si su valor es true y “falsoSoy ” si su valor es false.
  //Escribe tu código aquí

   
let esVerdadero = valor === true ;

if ( esVerdadero ) {return "Soy verdadero"}
